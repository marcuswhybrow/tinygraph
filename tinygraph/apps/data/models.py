...
class DataInstance(models.Model):
    ...
    rule = models.ForeignKey('rules.Rule', db_index=True, related_name='instances')
    # The closest match in the systems representation of DataObjects which
    # this data instance matches against
    data_object = models.ForeignKey('definitions.DataObject', db_index=True, related_name='instances')
