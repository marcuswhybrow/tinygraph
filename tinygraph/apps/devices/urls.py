...
from tinygraph.apps.rules.views import package_instance_detail
...
urlpatterns = patterns('devices.views',
    ...
    url(r'^d/(?P<device_slug>[-\w]+)/(?P<package_slug>[-\w]+)/$', package_instance_detail, name='package_instance_detail'),
